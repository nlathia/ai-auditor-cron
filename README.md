...
The website with the results is here: https://sentiment-ai-api-audit.herokuapp.com/ - and the repository for that website [is open source](https://github.com/nlathia/ai-auditor-web).
